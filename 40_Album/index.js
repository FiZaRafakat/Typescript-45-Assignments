// Qno 40 : "Album" __ Write a function called make_album() that builds a Object describing a music album. 
...
console.log(make_album("Fiza", "Music"));
console.log(make_album("Shiza", "Movies"));
console.log(make_album("Maheen", "Dramas", 8));
