...
var current_users = ["Fiza", "Laiba", "Anaya", "Anabya", "Kinza"];
var new_users = ["FIZA", "Maheen", "Rida", "Shanzay", "Anaya"];
new_users.forEach(function (new_one_user) {
    var conditon = current_users.some(function (current_users) { return current_users.toLowerCase() === new_one_user.toLocaleLowerCase(); });
    if (conditon) {
