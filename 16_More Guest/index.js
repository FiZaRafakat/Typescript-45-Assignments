...
var guest = ["Nazia", "Ansa", "Maheen", "Maria", "Mahnoor"];
// Print a message for a bigger dinner table,
guest.map(function (items) { return console.log("Hey , ".concat(items, " We arranged a dinner table.")); });
console.log("---------------------------------------------------------------");
...
guest.push("Fiza");
guest.map(function (items) { return console.log("Great new! ".concat(items, " We found a bigger table, So You all are invited.")); });
console.log("---------------------------------------------------------------");
